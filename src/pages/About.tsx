    ...
    <div className="w-full">
      ...
      <section className="py-20">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          >
            <div>
              <h2 className="text-4xl font-bold mb-6">배움 Story</h2>
              <p className="text-lg text-muted-foreground mb-4">
                (주)배움은 2000년에 설립되었으며, 학점은행제를 통해 누구나 쉽게
                대학 학위를 취득할 수 있도록 돕는 것을 목표로 합니다.
              </p>
              <p className="text-lg text-muted-foreground mb-4">
                우리는 직장인, 부모, 그리고 모든 꿈꾸는 사람들을 위해 유연하고
                질 높은 교육을 제공하고 있습니다.
              </p>
              <p className="text-lg text-muted-foreground">
                지금까지 10,000명 이상의 학생들이 우리와 함께 그들의 목표를
                달성했습니다.
              </p>
            </div>
            <motion.div
              ...
              transition={{ duration: 0.6 }}
              viewport={{ once: true }}
              className="bg-linear-to-br from-primary/10 to-primary/5 rounded-lg p-8 min-h-80 flex items-center justify-center"
            >
          ...
          >
            <Card className="border-l-4 border-l-primary">
              ...
              <CardContent className="text-lg text-muted-foreground">
                <p>
                  모든 사람이 자신의 속도에 맞춰 학습할 수 있도록 하며, 교육의
                  기회를 제공하여 사회 발전에 기여하는 것입니다.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="border-l-4 border-l-primary">
              ...
              <CardContent className="text-lg text-muted-foreground">
                <p>
                  학점은행제 분야의 선두주자가 되어 개개인의 꿈과 목표 달성을
                  통해 더 나은 미래를 만드는 것입니다.
                </p>
              </CardContent>
            </Card>
          </motion.div>
                      ...
                      <ul className="space-y-3">
                        {value.items.map((item, i) => (
                          <li key={i} className="flex items-center gap-3">
                            <CheckCircle2 className="h-5 w-5 text-primary flex-0" />
                            <span>{item}</span>
                          </li>
                        ))}
                      </ul>
      ...
      <section className="py-20 bg-muted/30">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          >
            {[
              { name: "김대영", role: "대표 이사", specialty: "교육학 박사" },
              {
                name: "김주영",
                role: "교육 담당자",
                specialty: "커리큘럼 개발",
